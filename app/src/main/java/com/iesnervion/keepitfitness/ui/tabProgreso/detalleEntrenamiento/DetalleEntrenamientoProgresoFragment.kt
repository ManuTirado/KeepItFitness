package com.iesnervion.keepitfitness.ui.tabProgreso.detalleEntrenamiento
...
import com.iesnervion.keepitfitness.databinding.FragmentDetalleEntrenamientoBinding
...
@AndroidEntryPoint
class DetalleEntrenamientoProgresoFragment : Fragment() {

    private var _binding: FragmentDetalleEntrenamientoBinding? = null
    private val binding get() = _binding!!

    private val args: DetalleEntrenamientoProgresoFragmentArgs by navArgs()
        ...
        requireActivity()
            ...
            .addCallback(viewLifecycleOwner, object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    val action =
                        DetalleEntrenamientoProgresoFragmentDirections.actionDetalleEntrenamientoProgresoFragmentToProgresoFragment()
