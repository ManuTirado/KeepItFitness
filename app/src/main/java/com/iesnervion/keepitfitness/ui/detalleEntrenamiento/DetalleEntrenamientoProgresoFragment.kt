package com.iesnervion.keepitfitness.ui.detalleEntrenamiento
...
class DetalleEntrenamientoProgresoFragment : Fragment() {
    ...
    private fun initListeners() {
        binding.bBack.setOnClickListener {
            val action = DetalleEntrenamientoProgresoFragmentDirections.actionDetalleEntrenamientoProgresoFragmentToProgresoFragment()
